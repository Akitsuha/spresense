...
extern "C" int main(int argc, FAR char *argv[])
{
  ...
  printf("helloxx_main: Asakura Saying hello from the dynamically constructed instance\n");
  ...
  printf("helloxx_main: Asakura Saying hello from the instance constructed on the stack\n");
